...
{
    /**
     * Gets the public 'App\Repository\QuoteRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuoteRepository.php';

        return $container->services['App\\Repository\\QuoteRepository'] = new \App\Repository\QuoteRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
