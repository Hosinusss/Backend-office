...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Form\\ProductType' => 'getProductTypeService',
            ...
            'App\\Repository\\QuoteRepository' => 'getQuoteRepositoryService',
            'App\\Repository\\SupplierRepository' => 'getSupplierRepositoryService',
    ...
    /**
     * Gets the private '.service_locator.V3KE_Z.' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_V3KEZ_Service()
    {
        return $this->privates['.service_locator.V3KE_Z.'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.signup' => ['privates', 'security.firewall.map.context.signup', 'getSecurity_Firewall_Map_Context_SignupService', true],
        ], [
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vgGUj69tsb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $a = ($this->privates['.service_locator.V3KE_Z.'] ?? $this->get_ServiceLocator_V3KEZ_Service());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.signup' => ($this->privates['.security.request_matcher.hd3kLJ7'] ?? ($this->privates['.security.request_matcher.hd3kLJ7'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/signup')));
